...
public class CategSpinnerAdapter extends BaseAdapter {
    Context context;
    JSONArray array;

    public CategSpinnerAdapter(Context context, JSONArray array) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View v;
        if(convertView==null){
            v= LayoutInflater.from(context).inflate(R.layout.categ_spinner_item,null);
